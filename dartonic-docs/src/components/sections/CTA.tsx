...
const SNIPPET = `import 'package:dartonic_sqlite/dartonic_sqlite.dart';
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-12 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href="https://pub.dev/packages/dartonic_core" target="_blank" rel="noreferrer" className="w-full sm:w-auto">
