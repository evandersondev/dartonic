...
> [!IMPORTANT]
> **Dartonic has moved to a modular set of packages.** This package (`dartonic`)
> is kept for backwards compatibility and is no longer actively developed. New
> projects should use the new ecosystem, starting with
> **[`dartonic_core`](https://pub.dev/packages/dartonic_core)**:
>
> | Package | Use it for |
> | --- | --- |
> | [`dartonic_core`](https://pub.dev/packages/dartonic_core) | Query builder, schema DSL, ORM, migrations (driver-agnostic) |
> | [`dartonic_sqlite`](https://pub.dev/packages/dartonic_sqlite) | SQLite driver — `connectSqlite()` |
> | [`dartonic_postgres`](https://pub.dev/packages/dartonic_postgres) | PostgreSQL driver — `connectPostgres()` |
> | [`dartonic_mysql`](https://pub.dev/packages/dartonic_mysql) | MySQL driver — `connectMysql()` |
>
> Only depend on the driver(s) you actually use. Docs: <https://github.com/evandersondev/dartonic>.
>
> ---
>
> **O Dartonic virou um conjunto modular de pacotes.** Este pacote (`dartonic`) é
> mantido por compatibilidade e não recebe mais desenvolvimento ativo. Projetos
> novos devem usar o novo ecossistema, começando por
> **[`dartonic_core`](https://pub.dev/packages/dartonic_core)** + o driver do seu banco.
